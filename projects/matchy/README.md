...
## Step 1 - Object Creation
 ...
 1. [ ] Using either notation, give `animal` a **property** called `noises` with a value of 
    empty array.
 1. [ ] Print your `animal` Object to the console by adding, `console.log(animal);`,
 1. [ ] Save your work (command-s || ctrl-s), switch back to the browser tab with your website running,
        and refresh your page to see what `animal` looks like.
